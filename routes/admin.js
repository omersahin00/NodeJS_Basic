...
router.get("/blogs/create", isAuth, adminController.get_blog_create);
...
router.post("/category/remove", isAuth, adminController.post_category_remove);
...
router.get("/category/:categoryid", isAuth,adminController.get_category_edit);
